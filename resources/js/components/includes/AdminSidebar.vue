            ...
            <ul id="menu" class="nav flex-column mb-2">
                ...
                <li>
                    <router-link :to="{ name: 'orders.index' }" class="nav-link">
                        ...
                        <span class="d-none d-sm-inline ps-2">Orders</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link :to="{ name: 'orders.create' }" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-cart-plus" viewBox="0 0 16 16">
                            <path d="M5.5 0a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 .5.5h.4a.6.6 0 0 1 .574.426l1.6 5.2a.5.5 0 0 1-.47.674H4.67a.5.5 0 0 1-.47-.674l1.6-5.2a.6.6 0 0 1 .574-.426h.4a.5.5 0 0 1 .5-.5h5V.5a.5.5 0 0 1 .5-.5z"/>
                        </svg>
                        <span class="d-none d-sm-inline ps-2">New Order</span>
                    </router-link>
                </li>
